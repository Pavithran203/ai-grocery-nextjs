  ...
  if (cartItems.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 flex flex-col items-center justify-center min-h-[60vh]">
        ...
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">{t('cart.yourCartIsEmpty')}</h2>
        <p className="text-gray-500 mb-8">{t('cart.looksLikeEmpty')}</p>
        <Link href="/" className="bg-emerald-500 text-black px-8 py-3 rounded-full font-bold hover:bg-emerald-600 transition-colors">
