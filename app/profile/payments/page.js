      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {methods.length > 0 ? (
          ...
          <div className="md:col-span-2 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[32px] p-8 text-center shadow-sm">
            <p className="text-gray-400 font-bold text-sm">No saved payment methods yet.</p>
            <p className="text-gray-400 text-xs mt-1">Your saved credit cards and UPI accounts will appear here.</p>
          </div>
        )}
