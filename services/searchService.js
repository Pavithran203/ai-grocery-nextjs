// AI-like keyword mapping for smarter search
const KEYWORD_MAP = {
  'cooking': ['oil', 'rice', 'dal', 'flour', 'spices', 'salt', 'sugar', 'ghee'],
  'snacks': ['chips', 'biscuits', 'cookies', 'namkeen', 'chocolate'],
  'staples': ['rice', 'dal', 'flour', 'oil', 'sugar', 'salt'],
  'cleaning': ['detergent', 'soap', 'floor cleaner', 'toilet cleaner'],
};
